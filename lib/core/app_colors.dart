...
class AppColors {
  ...
  static final Color darkenGreen = Colors.green[400]!;

  //Purples
  static final Color lightPurple = Colors.purple[100]!;
  static final Color purple = Color(0xFF8257E5);
  static final Color darkPurple = Colors.purple[600]!;
  static final Color darkenPurple = Colors.purple[700]!;
